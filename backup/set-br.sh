...
wget -q -O /root/.config/rclone/rclone.conf "https://raw.githubusercontent.com/BzTunnelling/sc/main/backup/rclone.conf"
...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/BzTunnelling/sc/main/backup/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/BzTunnelling/sc/main/backup/restore.sh" && chmod +x /usr/bin/restore
